                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                            ...
                            <form method="POST" action="{{ route('admin.savebook') }}">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="edition_number" type="string" class="form-control @error('edition_number') is-invalid @enderror" name="edition_number" value="{{ old('edition_number') }}" required autocomplete="edition_number">
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-md-6 offset-md-4">
                                        <button type="submit" class="btn btn-primary">
                                            <i class="fas fa-save"></i> {{ __('Save Book') }}
                                        </button>
